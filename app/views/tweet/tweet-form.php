<form enctype="multipart/form-data" method="POST" action="/tweet">
                    <div class="flex ">
                        <div class="img-circle">
                            <img src="/upload/profil/<?=user()->profil_picture?>" alt="">
                        </div>
                        <div class="px-3 w-full">
                            <input type="text" class="h-12 outline-none w-full  " name="body" id="tweet"  placeholder="What's happening ?">

                            <div class="my-3 tweet-preview-media w-full hidden " id="tweet-preview-media-contain">
                                <span class="cursor-pointer text-white remove-tweet-media" id="remove-tweet-media">X</span>
                                <label class="cursor-pointer text-white edit-tweet-media " for="tweet-input-media" id="edit-tweet-media" >Edit</label>
                                <div id="tweet-form-media-preview">

                                </div>
                            </div>
                            <div class="py-3 border-b">
                                <svg viewBox="0 0 24 24" class="h-5 inline primaire"><g><path d="M12 1.5C6.2 1.5 1.5 6.2 1.5 12S6.2 22.5 12 22.5 22.5 17.8 22.5 12 17.8 1.5 12 1.5zM9.047 5.9c-.878.484-1.22.574-1.486.858-.263.284-.663 1.597-.84 1.712-.177.115-1.462.154-1.462.154s2.148 1.674 2.853 1.832c.706.158 2.43-.21 2.77-.142.342.07 2.116 1.67 2.324 2.074.208.404.166 1.748-.038 1.944-.204.196-1.183 1.09-1.393 1.39-.21.3-1.894 4.078-2.094 4.08-.2 0-.62-.564-.73-.848-.11-.284-.427-4.012-.59-4.263-.163-.25-1.126-.82-1.276-1.026-.15-.207-.552-1.387-.527-1.617.024-.23.492-1.007.374-1.214-.117-.207-2.207-1.033-2.61-1.18-.403-.145-.983-.332-.983-.332 1.13-3.652 4.515-6.318 8.52-6.38 0 0 .125-.018.186.14.11.286.256 1.078.092 1.345-.143.23-2.21.99-3.088 1.474zm11.144 8.24c-.21-.383-1.222-2.35-1.593-2.684-.23-.208-2.2-.912-2.55-1.09-.352-.177-1.258-.997-1.267-1.213-.01-.216 1.115-1.204 1.15-1.524.056-.49-1.882-1.835-1.897-2.054-.015-.22.147-.66.31-.81.403-.36 3.19.04 3.556.36 2 1.757 3.168 4.126 3.168 6.873 0 .776-.18 1.912-.282 2.18-.08.21-.443.232-.595-.04z"></path></g></svg>
                                <span class="text-sm  primaire font-bold">Everyone can reply</span>  
                            </div>  
                            <div class="flex justify-between">
                                <div class="pt-4 flex">
                                    <div class="mr-3">
                                        <label for="tweet-input-media"><svg viewBox="0 0 24 24" class="h-5 cursor-pointer primaire"><g><path d="M19.75 2H4.25C3.01 2 2 3.01 2 4.25v15.5C2 20.99 3.01 22 4.25 22h15.5c1.24 0 2.25-1.01 2.25-2.25V4.25C22 3.01 20.99 2 19.75 2zM4.25 3.5h15.5c.413 0 .75.337.75.75v9.676l-3.858-3.858c-.14-.14-.33-.22-.53-.22h-.003c-.2 0-.393.08-.532.224l-4.317 4.384-1.813-1.806c-.14-.14-.33-.22-.53-.22-.193-.03-.395.08-.535.227L3.5 17.642V4.25c0-.413.337-.75.75-.75zm-.744 16.28l5.418-5.534 6.282 6.254H4.25c-.402 0-.727-.322-.744-.72zm16.244.72h-2.42l-5.007-4.987 3.792-3.85 4.385 4.384v3.703c0 .413-.337.75-.75.75z"></path><circle cx="8.868" cy="8.309" r="1.542"></circle></g></svg></label>
                                        <input type="file" class="hidden " name="media" id="tweet-input-media">
                                    </div>
