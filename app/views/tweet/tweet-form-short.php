<form enctype="multipart/form-data" method="POST" id="tweet-form-short" action="/tweet">
                    <div class="flex ">
                        <div class="img-circle">
                            <img src="/upload/profil/<?=user()->profil_picture?>" alt="">
                        </div>
                        <div class="px-3 w-full" id="">
                            <div id="short-body">
                                <input type="text" class="h-12 outline-none w-full  " name="body" id="tweet-short"  placeholder="What's happening ?">

                                <div class="my-3 tweet-preview-media w-full hidden " id="tweet-preview-media-contain-short">
                            ...
                            <div class="flex justify-between">
                                <div class="pt-4 flex">
                                    <div class="mr-3">
                                        <label for="tweet-input-media-short"><svg viewBox="0 0 24 24" class="h-5 cursor-pointer primaire"><g><path d="M19.75 2H4.25C3.01 2 2 3.01 2 4.25v15.5C2 20.99 3.01 22 4.25 22h15.5c1.24 0 2.25-1.01 2.25-2.25V4.25C22 3.01 20.99 2 19.75 2zM4.25 3.5h15.5c.413 0 .75.337.75.75v9.676l-3.858-3.858c-.14-.14-.33-.22-.53-.22h-.003c-.2 0-.393.08-.532.224l-4.317 4.384-1.813-1.806c-.14-.14-.33-.22-.53-.22-.193-.03-.395.08-.535.227L3.5 17.642V4.25c0-.413.337-.75.75-.75zm-.744 16.28l5.418-5.534 6.282 6.254H4.25c-.402 0-.727-.322-.744-.72zm16.244.72h-2.42l-5.007-4.987 3.792-3.85 4.385 4.384v3.703c0 .413-.337.75-.75.75z"></path><circle cx="8.868" cy="8.309" r="1.542"></circle></g></svg></label>
                                        <input type="file" class="hidden " name="media" id="tweet-input-media-short">
                                    </div>
